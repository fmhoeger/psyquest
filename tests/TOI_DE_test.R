...
dir <- system.file("tests/TOI_DE", package = "psyquest", mustWork = TRUE)
...
expect_equal(names(results), c("TOI", "results"))
expect_equal(results[[1]], list(q1="btn1_text", q2="btn2_text", q3="btn3_text", q4="btn4_text", q5="btn5_text", q6="btn6_text", q7="btn1_text"))
expect_equal(results[[2]], list(`Theory of Inteligence`=4.6666667, `Goals Choice`=3.25))
