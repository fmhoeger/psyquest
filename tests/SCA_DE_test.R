...
dir <- system.file("tests/SCA_DE", package = "psyquest", mustWork = TRUE)
...
expect_equal(names(results), c("SCA", "results"))
expect_equal(results[[1]], list(q1="btn1_text", q2="btn2_text", q3="btn3_text", q4="btn4_text", q5="btn1_text", q6="btn2_text", q7="btn3_text", q8="btn4_text",q9="btn1_text", q10="btn2_text", q11="btn3_text", q12="btn4_text",q13="btn1_text", q14="btn2_text", q15="btn3_text", q16="btn4_text",q17="btn1_text", q18="btn2_text", q19="btn3_text", q20="btn4_text",q21="btn1_text", q22="btn2_text", q23="btn3_text", q24="btn4_text",q25="btn1_text"))
expect_equal(results[[2]], list(General=84))
