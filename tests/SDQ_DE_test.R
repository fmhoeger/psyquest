...
dir <- system.file("tests/SDQ_DE", package = "psyquest", mustWork = TRUE)
...
expect_equal(names(results), c("SDQ", "results"))
expect_equal(results[[1]], list(q1="btn1_text", q2="btn2_text", q3="btn3_text", q4="btn1_text", q5="btn2_text", q6="btn3_text", q7="btn1_text", q8="btn2_text",q9="btn3_text", q10="btn1_text", q11="btn2_text", q12="btn3_text",q13="btn1_text", q14="btn2_text", q15="btn3_text", q16="btn1_text",q17="btn2_text", q18="btn3_text", q19="btn1_text", q20="btn2_text",q21="btn3_text", q22="btn1_text", q23="btn2_text", q24="btn3_text",q25="btn1_text"))
expect_equal(results[[2]], list(Prosocial=0.8, Difficulties=1.1, Hyperactivity=1, Externalising=1.2, `Emotional problems`=1, Internalising=1, `Conduct problems`=1.4, `Peer problems`=1))
