...
dir <- system.file("tests/TOM_DE", package = "psyquest", mustWork = TRUE)
...
expect_equal(names(results), c("TOM", "results"))
expect_equal(results[[1]], list(q1="btn1_text", q2="btn2_text", q3="btn3_text", q4="btn4_text", q5="btn5_text", q6="btn1_text", q7="btn2_text", q8="btn3_text", q9="btn4_text", q10="btn5_text", q11="btn1_text", q12="btn2_text"))
expect_equal(results[[2]], list(Gift=2, Entity=2.3333333, Improvement=3.3333333, Incremental=3.1666667, Learning=3, Stable=2.6666667))
