...
dir <-
  system.file("tests/SCA_short_DE", package = "psyquest", mustWork = TRUE)
...
app$expect_ui_text("Frage 1 von 4 Die meisten Fächer sind ziemlich leicht für mich. Stimme überhaupt nicht zu Stimme nicht zu Stimme zu Stimme sehr zu")
app$click("btn1_text")

app$expect_ui_text("Frage 2 von 4 Ich bin nicht sehr kreativ. Stimme überhaupt nicht zu Stimme nicht zu Stimme zu Stimme sehr zu")
app$click("btn2_text")
