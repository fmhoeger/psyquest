...
app <- AppTester$new("apps/battery_DE_DAC_PAC")
...
app$expect_ui_text(
  "Frage 2 von 4 An wie vielen Abenden hast du in den letzten drei Monaten Theater gespielt? Keinmal Einmal pro Woche 2- oder 3-mal pro Woche 4- oder 5-mal pro Woche 6- oder 7-mal pro Woche"
)
app$click("btn2_text")
...
app$expect_ui_text(
  "Frage 2 von 5 Wie oft hast du in den letzten drei Monaten nach der Schule Sport gemacht oder getanzt, z. B. in einer Schul-AG? Nie Einmal pro Woche 2- oder 3-mal pro Woche 4-mal pro Woche 5-mal pro Woche"
)
app$click("btn2_text")

app$expect_ui_text(
  "Frage 3 von 5 An wie vielen Nachmittagen pro Woche hast du außerhalb der Schule Sport gemacht oder getanzt? Nie Einmal pro Woche 2- oder 3-mal pro Woche 4- oder 5-mal pro Woche 6- oder 7-mal pro Woche"
)
app$click("btn3_text")

app$expect_ui_text(
  "Frage 4 von 5 Wie oft hast du in den letzten drei Monaten am Wochenende Sport gemacht oder getanzt? Nie An wenigen Wochenenden An einigen Wochenenden An den meisten Wochenenden Jedes Wochenende"
)
app$click("btn4_text")

app$expect_ui_text(
  "Frage 5 von 5 Wie oft hast du in den letzten drei Monaten in deiner Freizeit Sport gemacht, getanzt, Spiele gespielt etc.? Nie Manchmal (1- bis 2-mal pro Woche) Öfters (3- bis 4-mal pro Woche) Recht oft (5- bis 6-mal pro Woche) Sehr oft (7-mal oder mehr pro Woche)"
)
app$click("btn5_text")
