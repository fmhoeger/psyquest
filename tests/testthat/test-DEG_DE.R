...
app$expect_ui_text("Was ist deine Nationalität/Staatsangehörigkeit? (In welchem Land hast du deinen Pass?) British Afghanistan Bulgaria China Greece Iraq Iran Italy Kosovo Poland Romania Russia Serbia Syria Turkey other Next")
app$click_next()

app$expect_ui_text("In welchem Land hast du die meiste Zeit deines Lebens verbracht? UK Afghanistan Bulgaria China Greece Iraq Iran Italy Kosovo Poland Romania Russia Serbia Syria Turkey other Next")
app$click_next()
