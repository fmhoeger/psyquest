...
app$expect_ui_text("Please indicate the degree of current musical activities for the follow members of your family (tick all that apply). My mother … is playing an instrument. … is singing in a choir. Continue")
...
app$expect_ui_text("Please indicate the degree of current musical activities for the follow members of your family (tick all that apply). My father … is playing an instrument. … is singing in a choir. Continue")
# cb <- app$findElement(css = "input[value=choice1]")
# cb$click()
# cb <- app$findElement(css = "input[value=choice2]")
# cb$click()
