...
dir <- system.file("tests/battery_DE_DAC_PAC", package = "psyquest", mustWork = TRUE)
...
expect_equal(results[["DAC"]], list(q1="btn1_text", q2="btn2_text", q3="btn3_text", q4="btn4_text", General=2.5))
expect_equal(results[["PAC"]], list(q1="btn1_text", q2="btn2_text", q3="btn3_text", q4="btn4_text", q5="btn5_text", General=3))
