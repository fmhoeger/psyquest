...
dir <- system.file("tests/TPI_DE", package = "psyquest", mustWork = TRUE)
...
expect_equal(names(results), c("TPI", "results"))
expect_equal(results[[1]], list(q1="btn1_text", q2="btn2_text", q3="btn3_text", q4="btn4_text", q5="btn5_text", q6="btn6_text", q7="btn7_text", q8="btn1_text", q9="btn2_text", q10="btn3_text"))
expect_equal(results[[2]], list(Extraversion=1.5, Agreeableness=6.5, Conscientiousness=5, `Emotional Stability`=3, `Openness to Experiences`=5))
